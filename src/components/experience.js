                   ...
                   Experience</h1>
                    ...
                    <table>
                        <tr>
                            ...
                            <br />
                            <span className='subtitleDescription'>TELUS International Philippines · Internship</span> <br />
                            <span className='dateDescription'>Feb 2022 - May 2022</span>
                        ...
                        <tr>
                            ...
                            <td className='titleDescription'>Non-Voice Virtual Tutor 
                                <br/>
                                <span className='subtitleDescription'>Course Hero · Freelance</span> <br />
                                <span className='dateDescription'>Jun 2021 - Jan 2022</span>
                                <ul className='bulletedDescription'>
                           ...
                           <tr>
                            <td><img src={IEEE} alt='IEEE' width='45' height='50' /></td>  &nbsp;
                                ...
                                <br/>
                                <span className='subtitleDescription'>UST Institute of Electrical and Electronics Engineers - Student Branch (UST IEEE-SB)</span> <br />
                        ...
                        <tr>
                            <td><img src={CNAG} alt='CNAG' width='50' height='50' /></td>  &nbsp;
                                ...
                                <br/>
                                <span className='subtitleDescription'>UST Cisco Networking Academy Gateway - College of Information and Computing Sciences (CNAG-ICS)</span> <br />
                                <span className='dateDescription'>Aug 2020 - May 2021</span>
                                <ul className='bulletedDescription'>
                        ...
                        <tr>
                            <td><img src={AlgoFilipino} alt='AlgoFilipino' width='50' height='55' /></td>  &nbsp;
                                ...
                                <span className='dateDescription'>Feb 2021 - Mar 2021</span> <br />
                                <ul className='bulletedDescription'>
                        ...
                        <tr>
                            <td><img src={CNAG} alt='CNAG' width='50' height='50' /></td>  &nbsp;
                                ...
                                <br/>
                                <span className='subtitleDescription'>UST Cisco Networking Academy Gateway - College of Information and Computing Sciences (CNAG-ICS)</span> <br/>
                                <span className='dateDescription'>Aug 2019 - May 2020</span> 
                                <ul className='bulletedDescription'>

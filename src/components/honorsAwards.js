    ...
    return (
      <div className="initialDiv">
        ...
        <h1 className="titleHeader">
          <img src={Trophy} alt="trophy" width="50" height="50" /> &nbsp; Honors
          and Awards
        </h1>
        ...
        <table>
          <tr>
            <td>
              <img src={Synergy} alt="synergy" width="50" height="50" />
            </td>{" "}
            &nbsp;
            <td className="titleDescription">
              3rd Place at Stanford IT Learning's Software Solution
              <br />
              <span className="dateDescription">March 2021</span>
              <ul className="bulletedDescription">
                <li>
                  Proposed a mobile application called Freud which aims to
                  address mental health concerns through an interactive chatbot
                </li>
              </ul>
            </td>
          </tr>
          ...
          <tr>
            <td>
              <img src={UST} alt="ust" width="50" height="50" />
            </td>{" "}
            &nbsp;
            <td className="titleDescription">
              People's Choice Award (Design Layout Category)
              <br />
          ...
          <tr>
            <td>
              <img src={CICS} alt="cics" width="48" height="56" />
            </td>{" "}
            &nbsp;
            <td className="titleDescription">
              ...
              <span className="dateDescription">
                1st year to 4th year College
              </span>
              <ul className="bulletedDescription">
                <li>
                  University of Santo Tomas - College of Information and
                  Computing Sciences (UST CICS)
                </li>
              </ul>
            </td>
          </tr>
          ...
          <tr>
            <td>
              <img src={JHS} alt="jhs" width="50" height="50" />
            </td>{" "}
            &nbsp;
            <td className="titleDescription">
              Principal's List

...
//Contains Seminar Information
class Seminars extends React.Component {
  render() {
    return (
      <div className="initialDiv">
        <h1 className="titleHeader">
          <img src={Seminar} alt="seminar" width="55" height="55" /> &nbsp;
          Seminars Attended
        </h1>
        ...
        <table>
          <tr>
            <td>
              <img src={Leadership} alt="leader" width="50" height="50" />
            </td>{" "}
            &nbsp;
            <td className="titleDescription">
              Two-Day Leadership Training Seminar
              <br />
          ...
          <tr>
            ...
            &nbsp;
            <td className="titleDescription">
              Tech-Knowledge-G: Let's Git Together
              <br />
          ...
          <tr>
            <td>
              <img src={Interview} alt="tools" width="50" height="50" />
            </td>{" "}
            &nbsp;
            <td className="titleDescription">
              How To Ace your Web Developer interview - strategies for success
              <br />
